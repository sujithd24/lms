...
const ChaptersSidebar = () => {
  ...
  const handleGenerateCertificate = async () => {
    ...
    const img = new Image();
    img.src = "/certificates/template1.png"; // ✅ Template stored in public folder

    img.onload = () => {
      pdf.addImage(img, "PNG", 0, 0, 297, 210); // Fit to A4 landscape

      pdf.setFont("times", "bold");
      pdf.setFontSize(30);
      pdf.text(userName, 148, 115, { align: "center" }); // Align Name  
