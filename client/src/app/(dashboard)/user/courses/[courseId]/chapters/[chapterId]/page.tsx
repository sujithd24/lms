...
const Course = () => {
  ...
  const fetchQuizData = async (chapterId) => {
    ...
    setQuizError(null);
    try {
      const response = await axios.get(`http://localhost:8001/api/json/${chapterId}`);
    ...
    try {
      const response = await axios.post(
        ...
        },
        {
          headers: {
            ...
            "X-RapidAPI-Key": "650c283effmsh2e4156efd44fc37p149018jsn7d819d3dbc1e", // Replace with your API key
          },
        }
      );
      ...
      setTimeout(async () => {
        const result = await axios.get(
          ...
          {
            headers: {
              "X-RapidAPI-Key": "650c283effmsh2e4156efd44fc37p149018jsn7d819d3dbc1e",
            },
          }
        );
