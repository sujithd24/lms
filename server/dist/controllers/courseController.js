...
const updateCourse = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (updateData.price) {
            ...
            updateData.price = price * 100; // Store price in cents
        }
        if (updateData.sections) {
            const sectionsData = typeof updateData.sections === "string" ? JSON.parse(updateData.sections) : updateData.sections;
            updateData.sections = sectionsData.map((section) => (Object.assign(Object.assign({}, section), { sectionId: section.sectionId || (0, uuid_1.v4)(), chapters: section.chapters.map((chapter) => (Object.assign(Object.assign({}, chapter), { chapterId: chapter.chapterId || (0, uuid_1.v4)(), video: chapter.video || "", quiz: chapter.quiz || "", commands: chapter.commands || "" }))) })));
        }
